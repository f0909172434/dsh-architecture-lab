...
export async function prepareLinuxDshWorld(root,broker,{recipe='A',memorySnapshot,workspace:seed,allowUnacceptedImage=false}={}){
  ...
  if(memory){if(!memorySnapshot)throw new Error('memory snapshot required');add('memory/user.db',await readFile(memorySnapshot))}
