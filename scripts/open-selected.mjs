...
const profile = `lab-${selected.id.toLowerCase()}`
...
const child = spawn(process.execPath, [runtime.bin, '--profile', profile, ...process.argv.slice(2)], { cwd: project, env: { ...process.env, DSH_HOME: join(root, 'dsh-home') }, stdio: 'inherit' })
